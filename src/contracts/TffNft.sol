...
contract TffNft is ERC721Enumerable, Ownable {
    ...
    function payToMint(
        ...
        require(existingURIs[metadataURI] == 0, "This player is already minted!");
    ...
    function payToBuy(uint256 id) external payable {
        require(msg.value >= minted[id - 1].cost, "Ether too low for buying!");
